    ...
    <section className="bg-surface py-24">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <motion.div
            variants={slideUp}
            className="bg-white rounded-2xl p-10 border border-border-brand relative overflow-hidden"
          >
            <div className="absolute top-0 left-0 right-0 h-1 bg-teal rounded-t-2xl" />
            <span className="text-teal text-xs font-semibold uppercase tracking-widest">
              Our Mission
            </span>
            <h2 className="mt-3 text-2xl font-bold text-navy tracking-tight">
          ...
          <motion.div
            ...
            className="bg-white rounded-2xl p-10 border border-border-brand relative overflow-hidden"
          >
            <div className="absolute top-0 left-0 right-0 h-1 bg-navy rounded-t-2xl" />
