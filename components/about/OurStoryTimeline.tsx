    ...
    <section className="bg-white py-24">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative">
          <div className="absolute left-1/2 -translate-x-1/2 top-0 bottom-0 w-px bg-[#e4e8ef] hidden lg:block" />
              ...
              return (
                ...
                >
                  <motion.div
                    ...
                    className={`bg-[#f8f9fb] rounded-2xl p-8 border border-[#e4e8ef] ${
                  ...
                  >
                    <div className="flex items-center gap-4">
                      <div className="w-14 h-14 rounded-full bg-[#02807e] flex items-center justify-center flex-shrink-0">
